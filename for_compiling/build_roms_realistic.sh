...
export   ROMS_APPLICATION=REALISTIC
...
export ROMS_ROOT_DIR=/home/vboatwright/boat_roms/roms
...
#export NETCDF_INCDIR=/usr/lib64/gfortran/modules/openmpi
#--------------------------------------------------------------------------
# Compile.
#--------------------------------------------------------------------------
